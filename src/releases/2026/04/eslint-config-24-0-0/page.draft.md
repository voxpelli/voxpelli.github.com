---
layout: article
title: '@voxpelli/eslint-config 24.0.0'
date: '2026-04-15T09:02:20Z'
lang: en
category: release
tags: [release, eslint-config, ai-placeholder]
mf-bookmark-of:
  - 'https://github.com/voxpelli/eslint-config/releases/tag/v24.0.0'
---
...
Major release bumping to `neostandard` ^0.13.0, raising the Node.js floor to >=20.x, and updating `eslint-plugin-sort-destructure-keys` to v3. Two breaking changes, plus a `neostandard` fix and a broad dependency sweep.
...
> ### ⚠ BREAKING CHANGES
>
> * update dependency eslint-plugin-sort-destructure-keys to v3 ([#442](https://github.com/voxpelli/eslint-config/issues/442))
...
> * update dependency eslint-plugin-sort-destructure-keys to v3 ([#442](https://github.com/voxpelli/eslint-config/issues/442)) ([609692a](https://github.com/voxpelli/eslint-config/commit/609692a97692db4d6bc0ad86f9e9d5137cd7e3aa))
>
> ### 🩹 Fixes
>
...
> ### 🧹 Chores
>
> * add context7.json with configuration details ([6ad8c6d](https://github.com/voxpelli/eslint-config/commit/6ad8c6d8dd43418a6bd588787ba2542eb17f6895))
...
Full details, commit history, and source at the [GitHub release page](https://github.com/voxpelli/eslint-config/releases/tag/v24.0.0).
