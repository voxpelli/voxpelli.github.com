...
layout: article
title: 'peowly 1.3.3'
date: '2026-02-10T09:29:16Z'
lang: en
category: release
tags: [release, peowly, ai-placeholder]
mf-bookmark-of:
  - 'https://github.com/voxpelli/peowly/releases/tag/v1.3.3'
---
...
Patch release fixing the type definitions for multi flags, alongside a README restructure for clarity and new type + unit test coverage.
...
Full details, commit history, and source at the [GitHub release page](https://github.com/voxpelli/peowly/releases/tag/v1.3.3).
